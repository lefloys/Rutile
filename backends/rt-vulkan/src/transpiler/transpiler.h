#ifndef RTVK_SPIRV_TRANSPILER_H
#define RTVK_SPIRV_TRANSPILER_H
...
RTVK_API rt_spirv_status rt_spirv_transpile(const uint8_t* bytes, size_t byte_size, const char* entry_name, rt_spirv_program** program, char* message, size_t message_size);
RTVK_API int rt_spirv_validate(const uint32_t* words, size_t word_count, char* message, size_t message_size);
