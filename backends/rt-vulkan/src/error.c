...
const char* rtvk_rt_error_name(enum rt_error error) {
	...
	case RT_PLATFORM_FAILURE:
		return "RT_PLATFORM_FAILURE";
	case RT_DEVICE_LOST:
		return "RT_DEVICE_LOST";
	case RT_ALREADY_INITIALIZED:
		return "RT_ALREADY_INITIALIZED";
	case RT_UNSUPPORTED_PLATFORM:
		return "RT_UNSUPPORTED_PLATFORM";
	case RT_NO_BACKEND:
		return "RT_NO_BACKEND";
	case RT_UNSUPPORTED_FEATURE:
		return "RT_UNSUPPORTED_FEATURE";
	...
	case RT_SHADER_COMPILATION_FAILED:
		return "RT_SHADER_COMPILATION_FAILED";
	case RT_SHADER_LINK_FAILED:
		return "RT_SHADER_LINK_FAILED";
	case RT_FEATURE_NOT_SUPPORTED:
		return "RT_FEATURE_NOT_SUPPORTED";
	default:
		return "RT_ERROR_<unknown>";
	}
}
