...
RTVK_API void rtGraphicsProgramSource(rt_graphics_program program, const void* data, usize size);
...
RTVK_API rt_location rtGraphicsProgramLocation(rt_graphics_program program, const char* name);
...
struct rtvk_graphics_program {
	...
	rt_vertex_stream vertex_streams[RTVK_MAX_VERTEX_ATTRIBUTES];
