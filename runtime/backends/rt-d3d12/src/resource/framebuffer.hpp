...
RTDX_API rt_texture_view rtFramebufferColorView(rt_framebuffer framebuffer, rt_location location);
RTDX_API void rtFramebufferSetColorView(rt_framebuffer framebuffer, rt_texture_view view, rt_location location);
RTDX_API void rtFramebufferSetDepthView(rt_framebuffer framebuffer, rt_texture_view view);
RTDX_API void rtFramebufferSetStencilView(rt_framebuffer framebuffer, rt_texture_view view);
...
void rtdx_framebuffer_set_stencil_view(rtdx_context* ctx, rtdx_framebuffer* framebuffer, rtdx_texture_view* view);
