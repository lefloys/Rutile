...
RT_API_PUBLIC rt_buffer rtBufferCreate(void) { return rtlog_rtBufferCreate(); }
RT_API_PUBLIC void rtBufferDestroy(rt_buffer buffer) { rtlog_rtBufferDestroy(buffer); }
RT_API_PUBLIC rt_timepoint rtBufferData(rt_buffer buffer, enum rt_buffer_mode mode, enum rt_buffer_usage usage, usize size, const void* data) { return rtlog_rtBufferData(buffer, mode, usage, size, data); }
RT_API_PUBLIC rt_timepoint rtBufferSubdata(rt_buffer buffer, usize offset, usize size, const void* data) { return rtlog_rtBufferSubdata(buffer, offset, size, data); }
RT_API_PUBLIC void rtBufferRead(rt_buffer buffer, usize offset, usize size, void* data) { rtlog_rtBufferRead(buffer, offset, size, data); }
...
rt_timepoint rtlog_rtBufferData(rt_buffer buffer, enum rt_buffer_mode mode, enum rt_buffer_usage usage, usize size, const void* data) {
	u64 start_ns = rtlog_now_ns();
...
rt_timepoint rtlog_rtBufferSubdata(rt_buffer buffer, usize offset, usize size, const void* data) {
	u64 start_ns = rtlog_now_ns();
...
void rtlog_rtBufferRead(rt_buffer buffer, usize offset, usize size, void* data) {
	u64 start_ns = rtlog_now_ns();
