...
extern PFN_rtCommandContextCreate next_rtCommandContextCreate;
extern PFN_rtCommandContextDestroy next_rtCommandContextDestroy;
extern PFN_rtCommandContextBind next_rtCommandContextBind;
extern PFN_rtCommandContextAllocate next_rtCommandContextAllocate;
extern PFN_rtCommandBufferDestroy next_rtCommandBufferDestroy;
extern PFN_rtCmdReset next_rtCmdReset;
extern PFN_rtCmdBegin next_rtCmdBegin;
extern PFN_rtCommandContextBindFramebuffer next_rtCommandContextBindFramebuffer;
extern PFN_rtCommandContextClearColor next_rtCommandContextClearColor;
extern PFN_rtCommandContextClearDepth next_rtCommandContextClearDepth;
extern PFN_rtCommandContextClearStencil next_rtCommandContextClearStencil;
...
extern PFN_rtCommandContextEndRendering next_rtCommandContextEndRendering;
extern PFN_rtCommandContextExecute next_rtCommandContextExecute;
extern PFN_rtCmdEnd next_rtCmdEnd;
extern PFN_rtQueueQuery next_rtQueueQuery;
extern PFN_rtQueueWait next_rtQueueWait;
extern PFN_rtCommandContextSubmit next_rtCommandContextSubmit;
...
void rtlog_rtCommandContextDestroy(rt_command_context command_context);
void rtlog_rtCommandContextBind(rt_command_context command_context, rt_queue queue);
rt_command_buffer rtlog_rtCommandContextAllocate(rt_command_context command_context);
void rtlog_rtCommandBufferDestroy(rt_command_buffer command_buffer);
void rtlog_rtCmdReset(rt_command_buffer command_buffer);
...
void rtlog_rtCommandContextClearColor(rt_command_context command_context, u32 color_index, f32 r, f32 g, f32 b, f32 a);
void rtlog_rtCommandContextClearDepth(rt_command_context command_context, f32 depth);
void rtlog_rtCommandContextClearStencil(rt_command_context command_context, u32 stencil);
...
void rtlog_rtCommandContextEndRendering(rt_command_context command_context);
void rtlog_rtCommandContextExecute(rt_command_context command_context, rt_command_buffer command_buffer);
...
rt_timepoint rtlog_rtCommandContextSubmit(rt_command_context command_context);
