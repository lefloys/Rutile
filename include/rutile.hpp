...
#define RT_CORE_PROCEDURES(X)                                                                     \
	...
	X( void                 , rtCmdDispatch                    , (rt_command_buffer_t* command_buffer, usize group_count_x, usize group_count_y, usize group_count_z)                                                                                                                    , (command_buffer, group_count_x, group_count_y, group_count_z)                            ) \
...
void rtLoadSwapchain();
void rtLoadGlfwSwapchain();
...
#define RT_GLFW_SWAPCHAIN_PROCEDURES(X) \
	X(void, rtSwapchainBindGLFW, (rt_swapchain_t* swapchain, struct GLFWwindow* window), (swapchain, window))
