...
RT_SWAPCHAIN_PROCEDURES(RTLOG_DEFINE_EXTENSION_NEXT)
RT_GLFW_SWAPCHAIN_PROCEDURES(RTLOG_DEFINE_EXTENSION_NEXT)
...
#define RTLOG_RESOLVE_EXTENSION_NEXT(return_type, name, parameters, arguments) next_##name = (return_type (*) parameters)next.get_proc(&next, #name);
	RT_SWAPCHAIN_PROCEDURES(RTLOG_RESOLVE_EXTENSION_NEXT)
	RT_GLFW_SWAPCHAIN_PROCEDURES(RTLOG_RESOLVE_EXTENSION_NEXT)
